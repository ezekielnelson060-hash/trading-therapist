...
class User(Base):
    ...
    behavioral_events: Mapped[List["BehavioralEvent"]] = relationship(
        "BehavioralEvent", back_populates="user", cascade="all, delete-orphan"
    )
    emotional_logs: Mapped[List["EmotionalLog"]] = relationship(
        "EmotionalLog", back_populates="user", cascade="all, delete-orphan"
    )
    chat_sessions: Mapped[List["ChatSession"]] = relationship(
        "ChatSession", back_populates="user", cascade="all, delete-orphan"
    )
    trading_plans: Mapped[List["TradingPlan"]] = relationship(
        "TradingPlan", back_populates="user", cascade="all, delete-orphan"
    )
